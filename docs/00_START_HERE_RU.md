...
Текущая работа: **Phase 6 — Fastboot DATA IN + modern partition workflows**.
Phase 5 закрыта: незапертых пунктов в ней нет, а два оставшихся ждут Phase 6 и
Phase 8 по решению, а не по забывчивости (`09`, `07` §6.75).
