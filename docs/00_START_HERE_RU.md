...
Текущая работа: **Phase 5 — Fastboot generic engine**. Она была закрыта и открыта
обратно в тот же день: один из двух пунктов, названных запертыми, запертым не был
(`09`, `07` §6.80).
