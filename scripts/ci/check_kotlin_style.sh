...
if java -jar "$DETEKT_JAR" \
    --input app/src/main,core/model/src/main,core/diagnostics/src/main,core/operation/src/main,core/artifact/src/main,usb/api/src/main,usb/android/src/main,protocol/adb/src/main \
